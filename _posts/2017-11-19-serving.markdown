...
- [Flask](http://flask.pocoo.org) to build the API (back-end)
- [jquery.ajax](http://api.jquery.com/jquery.ajax/) to handle requests to the API in whatever front-end you use (github pages for instance)
